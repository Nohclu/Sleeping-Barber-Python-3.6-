...
class Barber(threading.Thread):     #Consumer Thread
    ...
    def run(self):
        while True:            
            ...
            cust.get()  #FIFO Queue So first customer added is gotten.
            Customer.trim(cust) #Customers Hair is being cut
...
if __name__ == '__main__':
    ...
    for c in range(1000): #Loop that creates infinite Customers
        print("----")
